...
import sneakerl from './icons/leftchanel.png'
import sneakerr from './icons/rightchanel.png'
...
const Chanel=()=>{
    return(
        <div className="fullscreen flex w-screen h-screen" >
            <div className="piece items-container w-1/3">
                ...
                <div className="h-32 pl-10 pl-20">
                    ...
                    <div className="">
                        <h1 className="text-3xl font-bold">Chanel Sneakers</h1>
                        <p className="text-3xl secondline font-bold">2019 Collection</p>
                    </div>
            ...
            <div className="piece circle-container w-1/3 "  >
                <div className="circle hvr-pop">

                </div>
                <div className=""><img src={sneakerl} className="w-600px leftboot1" alt=""/></div>
                <div className=""><img src={sneakerr} className="w-600px rightboot1" alt=""/></div>
            </div>
            <div className='piece flex flex-col justify-between items-end relative w-1/3'>
                <div className="flex pr-20 pt-20">
                    ...
                    <div className=""><img src={photosquare} className="w-6 h-6 rounded-full object-cover " alt=""/></div>
                </div>
